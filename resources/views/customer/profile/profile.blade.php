                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="row">
                            <section class="col-6 border-bottom mb-2 py-2">
                                ...
                                <section
                                    class="field-value overflow-auto">{{ $user->first_name ?? '-' }}</section>
                            </section>
                            <section class="col-6 border-bottom my-2 py-2">
                                <section class="field-title">نام خانوادگی</section>
                                <section
                                    class="field-value overflow-auto">{{ $user->last_name ?? '-' }}</section>
                            </section>
                            <section class="col-6 border-bottom my-2 py-2">
                            ...
                            <section class="col-6 my-2 py-2">
                                ...
                                <section class="field-value overflow-auto">{{ $user->national_code ?? '-' }}
                                </section>
                            </section>
                        </section>
                            ...
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    ...
                                    <section class="modal-footer py-1">
                                        <button type="submit" form="update-profile" class="btn btn-sm btn-primary">ویرایش
                                        </button>
