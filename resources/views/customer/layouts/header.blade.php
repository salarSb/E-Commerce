                        ...
                        <section class="search-textbox">
                            <form class="d-flex w-100" action="{{ route('customer.products') }}" method="get">
                                ...
                                <input id="search" type="text" class="" name="search"
                                       value="{{ request()->query('search') }}" placeholder="جستجو ..."
                                       autocomplete="off">
                            </form>
                        </section>
                ...
                <section class="mt-3 mt-md-auto text-end">
                        ...
                        @auth()
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="{{ route('profile.index') }}"><i
                                            class="fa fa-user-circle"></i>پروفایل
                                        کاربری</a></section>
                                <section><a class="dropdown-item"
                                            href="{{ route('profile.order') }}"><i
                                            class="fa fa-newspaper"></i>سفارشات</a>
                                </section>
                                <section><a class="dropdown-item"
                                            href="{{ route('profile.my-favorites.index') }}"><i
                                ...
                                <section><a class="dropdown-item"
                                            href="{{ route('auth.customer.logout') }}"><i
                    ...
                    @guest
                        <a href="{{ route('auth.customer.login-register-form') }}"
                           class="btn btn-link text-decoration-none text-dark profile-button"> <i
                            ...
                            <section class="header-cart-dropdown">
                                        ...
                                        <section
                                            ...
                                            <section class="w-100 text-truncate">
                                                <a class="text-decoration-none text-dark"
                                                   href="{{ route('customer.market.product', $cartItem->product->slug) }}">
                                ...
                                <section
                                    ...
                                    <section class="">
                                        ...
                                        <section>{{ priceFormat($totalProductPrice) }}</section>
                                    </section>
