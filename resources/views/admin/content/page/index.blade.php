                                ...
                                <td>
                                    <label>
                                        <input id="{{ $page->id }}"
                                               ...
                                               data-url="{{ route('admin.content.page.status', $page->slug) }}"
                                               @if($page->status === 1) checked @endif>
                                    </label>
                                </td>
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.content.page.edit', $page->slug) }}"
                                       class="btn btn-sm btn-primary"><i class="fa fa-edit ml-1"></i>
                                        ویرایش
                                    </a>
                                    <form action="{{ route('admin.content.page.destroy',$page->slug) }}"
