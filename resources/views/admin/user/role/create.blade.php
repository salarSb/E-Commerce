...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active font-size-12" aria-current="page">ایجاد نقش</li>
        </ol>
    </nav>
    <section class="row">
                                ...
                                <section class="row border-top mt-3 py-3">
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check1" class="form-check-label mr-3 mt-1">
                                                نمایش دسته جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check2" class="form-check-label mr-3 mt-1">
                                                ایجاد دسته جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check3" class="form-check-label mr-3 mt-1">
                                                ویرایش دسته جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check4" class="form-check-label mr-3 mt-1">
                                                حذف دسته جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check5" class="form-check-label mr-3 mt-1">
                                                نمایش کالا جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check6" class="form-check-label mr-3 mt-1">
                                                ایجاد کالا جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check7" class="form-check-label mr-3 mt-1">
                                                ویرایش کالا جدید
                                            </label>
                                        </div>
                                    </section>
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            ...
                                            <label for="check8" class="form-check-label mr-3 mt-1">
                                                حذف کالا جدید
                                            </label>
                                        </div>
                                    </section>
