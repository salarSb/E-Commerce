                            ...
                            <tr>
                                ...
                                <td>
                                    <img
                                        ...
                                        alt="brand image" width="50" height="50">
                                </td>
                                <td>{{ $brand->tags }}</td>
                                <td>
                                    <label>
                                        <input id="{{ $brand->id }}"
                                               onchange="changeStatus({{ $brand->id }})" type="checkbox"
                                               data-url="{{ route('admin.market.brand.status', $brand->slug) }}"
                                               @if($brand->status === 1) checked @endif>
                                    </label>
                                </td>
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.market.brand.edit', $brand->slug) }}"
                                       class="btn btn-sm btn-primary">
                                        <i class="fa fa-edit ml-1"></i>
                                        ویرایش
                                    </a>
                                    <form action="{{ route('admin.market.brand.destroy',$brand->slug) }}"
