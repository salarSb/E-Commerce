...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active font-size-12" aria-current="page">فروش شگفت انگیز</li>
        </ol>
    </nav>
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.market.discount.amazingSale.create') }}" class="btn btn-info btn-sm">
                        افزودن کالا به لیست فروش شگفت انگیز
                    </a>
                                ...
                                <td>
                                    <label>
                                        <input id="{{ $amazingSale->id }}"
                                               onchange="changeStatus({{ $amazingSale->id }})" type="checkbox"
                                               data-url="{{ route('admin.market.discount.amazingSale.status', $amazingSale->id) }}"
                                               @if($amazingSale->status === 1) checked @endif>
                                    </label>
                                </td>
