...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active font-size-12" aria-current="page">ایجاد رنگ کالا</li>
        </ol>
    </nav>
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.product.color.store', $product->slug) }}" method="post">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input id="price_increase" name="price_increase" value="{{ old('price_increase') }}"
                                           class="form-control form-control-sm" type="text">
                                </div>
