...
@section('head-tag')
    ...
    <title>ایجاد گارانتی برای کالا</title>
@endsection
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active font-size-12" aria-current="page">ایجاد گارانتی برای کالا</li>
        </ol>
    </nav>
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.product.guarantee.store', $product->slug) }}" method="post">
                        @csrf
                        <section class="row">
