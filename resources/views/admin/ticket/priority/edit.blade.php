...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active font-size-12" aria-current="page">ویرایش اولویت تیکت</li>
        </ol>
    </nav>
    <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" class="form-control form-control-sm"
                                           type="text" value="{{ old('name', $ticketPriority->name) }}">
                                </div>
                                @error('name')
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input id="display_name" name="display_name" class="form-control form-control-sm"
                                           type="text" value="{{ old('display_name', $ticketPriority->display_name) }}">
                                </div>
                                @error('display_name')
                                <span class="alert-required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control form-control-sm">
                                        <option value="1"
                                                @if(old('status', $ticketPriority->status) == 1) selected @endif>
                                            فعال
                                        </option>
                                        <option value="0"
