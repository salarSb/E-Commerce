...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->tinyInteger('delivery_status')->default(0)->comment('0 => not shipped, 1 => sending, 2 => posted, 3 => delivered');
            ...
            $table->tinyInteger('order_status')->default(0)->comment('0 => not checked 1 => awaiting approval, 2 => not approved, 3 => approved, 4 => canceled, 5 => returned');
            $table->timestamps();
            $table->softDeletes();
        });
    }
